...
from .views import ProjectList, ProjectDetail,ListProject,BoardProject
...
urlpatterns = [
    ...
    path('board-tasks/<int:pk>/', BoardProject.as_view({'get': 'listAll', 'post': 'createOne'}), name='board-task'),  
