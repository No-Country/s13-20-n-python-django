...
from accounts.api.serializers import UserSerializer, UserListSerializer, UserUpdateSerializer
...
class UserModelViewSet(GenericViewSet):
    ...
    queryset = serializer_class.Meta.model.objects.filter(is_active=True).order_by("last_name")
    ...
    @extend_schema(description="Obtiene la lista de todos los usuarios", summary="Users")
