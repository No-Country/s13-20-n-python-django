    ...
    <div className="w-72 max-h-full flex flex-col rounded-md border-2">
      ...
      <div className="flex items-center justify-between px-3 py-2">
        ...
        <button className="hover:bg-gray-300 w-8 h-8 rounded-md grid place-content-center dropdown">
          ...
          <ul className="p-2 shadow menu dropdown-content z-[1] bg-base-100 rounded-box w-52">
            ...
            <li>
              <a onClick={() => document.getElementById('add_card_modal').showModal()}>Add card</a>
            </li>
            <li>
              <a>Move list</a>
            </li>
            ...
            <div className="divider my-0"></div>
            <li>
              <a onClick={() => document.getElementById('delete_card_modal').showModal()} className="text-red-500">Remove list</a>
            </li>
          </ul>
        </button>
      </div>
      ...
      <div className="px-3 pb-3 mt-3">
        <button className="flex items-center p-2 text-sm font-medium hover:text-black hover:bg-gray-300 w-full rounded-md">
          +<span className="ml-1" onClick={() => document.getElementById('add_card_modal').showModal()}>Add card</span>
        </button>
      </div>

      {/* Modals */}
      <dialog id="add_card_modal" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          <h3 className="font-bold text-lg mb-4">Add a new task (or press ESC to exit)</h3>
      ...
      <dialog id="delete_card_modal" className="modal">
        <div className="modal-box">
          ...
          <p className="py-4">Are you sure you want to delete this list? Press ESC key or close this window to cancel.</p>
          <div className="modal-action">
            <form method="dialog">
              {/* if there is a button in form, it will close the modal */}
              <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
