    ...
    return (
        <div className='flex justify-between items-center h-[10vh] px-4 py-3'>
            <div className='flex justify-center items-center'>
                ...
                <img src={iconDown} alt="" className='w-3 ml-2 mt-2 cursor-pointer md:hidden' onClick={() => setOpenMenu(state => !state)} />
            </div>
            <div className='flex justify-center items-center gap-5 md:gap-10'>
                ...
                <div className="dropdown dropdown-end">
                    ...
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-2 z-[1] p-2 shadow bg-base-100 rounded-box w-32">
                        <li><a>Username</a></li>
