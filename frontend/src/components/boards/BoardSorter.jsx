...
import { useCreateNewListMutation } from "../../services/listSlice";
...
const BoardSorter = ({ data }) => {
  ...
  const [createNewList, { requestData, isLoading, isError }] =
    useCreateNewListMutation();

  function handleAddList(event) {
    event.preventDefault();
    createNewList({ title: listName, board: data.id });
    setListName("");
    document.getElementById("add_list_modal").close();
  }
